...
public interface EventLocalService
	...
	public Event addEvent(
		String name, String description, Date occursOn, Date endsOn,
		int maxOccupants, boolean adultsOnly, int floor, String room,
		long organizer);
