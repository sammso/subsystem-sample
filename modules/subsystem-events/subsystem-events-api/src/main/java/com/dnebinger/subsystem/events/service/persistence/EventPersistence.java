...
public interface EventPersistence extends BasePersistence<Event> {
	 ...
	 * @return the matching events
	 */
	public java.util.List<Event> findByName(String name);
	 ...
	 * @return the range of matching events
	 */
	public java.util.List<Event> findByName(String name, int start, int end);
	 ...
	 * @return the ordered range of matching events
	 */
	public java.util.List<Event> findByName(
