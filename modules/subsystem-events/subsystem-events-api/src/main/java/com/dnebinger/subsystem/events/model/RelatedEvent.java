...
@ImplementationClassName(
	"com.dnebinger.subsystem.events.model.impl.RelatedEventImpl"
)
@ProviderType
public interface RelatedEvent extends PersistedModel, RelatedEventModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>com.dnebinger.subsystem.events.model.impl.RelatedEventImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<RelatedEvent, Long> SURROGATE_ID_ACCESSOR =
		new Accessor<RelatedEvent, Long>() {
