...
/**
 * The persistence utility for the event attendee service. This utility wraps <code>com.dnebinger.subsystem.events.service.persistence.impl.EventAttendeePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class EventAttendeeUtil {
	 ...
	 */
	public static Map<Serializable, EventAttendee> fetchByPrimaryKeys(
	 ...
	 */
	public static EventAttendee update(
		EventAttendee eventAttendee, ServiceContext serviceContext) {
	 ...
	 */
	public static List<EventAttendee> findByEventId(
	 ...
	 */
	public static EventAttendee findByEventId_First(
			long eventId, OrderByComparator<EventAttendee> orderByComparator)
		throws com.dnebinger.subsystem.events.exception.
			NoSuchEventAttendeeException {
	 ...
	 */
	public static EventAttendee fetchByEventId_First(
		long eventId, OrderByComparator<EventAttendee> orderByComparator) {
	 ...
	 * @throws NoSuchEventAttendeeException if a matching event attendee could not be found
	 */
	public static EventAttendee findByEventId_Last(
			long eventId, OrderByComparator<EventAttendee> orderByComparator)
		throws com.dnebinger.subsystem.events.exception.
			NoSuchEventAttendeeException {
	 ...
	 */
	public static EventAttendee fetchByEventId_Last(
		long eventId, OrderByComparator<EventAttendee> orderByComparator) {
	 ...
	 */
	public static EventAttendee[] findByEventId_PrevAndNext(
		...
		return getPersistence().findByEventId_PrevAndNext(
			surrogateId, eventId, orderByComparator);
	}
	...
	private static ServiceTracker
		<EventAttendeePersistence, EventAttendeePersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(EventAttendeePersistence.class);

		ServiceTracker<EventAttendeePersistence, EventAttendeePersistence>
			serviceTracker =
				new ServiceTracker
					<EventAttendeePersistence, EventAttendeePersistence>(
						bundle.getBundleContext(),
						EventAttendeePersistence.class, null);
