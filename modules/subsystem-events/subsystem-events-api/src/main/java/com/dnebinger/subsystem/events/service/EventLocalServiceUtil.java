 ...
 * <code>com.dnebinger.subsystem.events.service.impl.EventLocalServiceImpl</code> and
...
public class EventLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.dnebinger.subsystem.events.service.impl.EventLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.dnebinger.subsystem.events.model.Event addEvent(
	...
	public static com.dnebinger.subsystem.events.model.Event addEvent(
		String name, String description, java.util.Date occursOn,
		java.util.Date endsOn, int maxOccupants, boolean adultsOnly, int floor,
		String room, long organizer) {

		return getService().addEvent(
			name, description, occursOn, endsOn, maxOccupants, adultsOnly,
			floor, room, organizer);
	}
	 ...
	 */
	public static com.dnebinger.subsystem.events.model.Event createEvent(
		long eventId) {
	 ...
	 */
	public static com.dnebinger.subsystem.events.model.Event deleteEvent(
		com.dnebinger.subsystem.events.model.Event event) {
	...
	public static com.dnebinger.subsystem.events.model.Event fetchEvent(
		long eventId) {
	 ...
	 */
	public static com.dnebinger.subsystem.events.model.Event updateEvent(
		com.dnebinger.subsystem.events.model.Event event) {
