...
/**
 * The extended model base implementation for the RelatedEvent service. Represents a row in the &quot;SUBSYS_RelatedEvent&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This class exists only as a container for the default extended model level methods generated by ServiceBuilder. Helper methods and all application logic should be put in {@link RelatedEventImpl}.
 * </p>
 *
...
public abstract class RelatedEventBaseImpl
	...
	public void persist() {
		if (this.isNew()) {
			RelatedEventLocalServiceUtil.addRelatedEvent(this);
		}
		else {
